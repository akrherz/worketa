...
#    this option, it is imperative that you read AWIPS_VIEWING.readme   #
...
#           data into AWIPS. Please read AWIPS_VIEWING.readme for more  #
...
#          Please see AWIPS_VIEWING.readme for more information.        #
#                                                                       #
#########################################################################
set AWIPS = ftp
...
#    AWIPS_VIEWING.readme file and that you have write permission on 
...
#    or ingest for processing and display. 
#
#set  AWIPS_MACHINE = awips.ip.address
#set  REM_AWIPS_DIR = /data/Incoming
set  AWIPS_MACHINE = soosac.comet.ucar.edu
set  REM_AWIPS_DIR = for_bob
...
#
   ...
   ${ETA_EXE}/nagrib < gemfile >> $ETA_TMP/gempak.log
   ${ETA_EXE}/gpend >& /dev/null
   rm -f gemfile
