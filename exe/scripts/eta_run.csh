...
#########################################################################
#    MODEL_RUN  { HYDROSTATIC | NON-HYDROSTATIC }                       #
#                                                                       #
...
#
set OUT_PLEVS = ( 550 650 750 927 100 200 300 400 850 925 \
                  1000 510 600 700 150 250 350 450 )
...
if ( $P_METHOD == 2 ) then
   ...
   if ( $LSM <= 0 ) then
      ...
      echo "       pressure levels ( see item 12 )"
      echo " "
      exit 1
   endif
else
   echo "OOPS:  You have not selected a valid method for outputting"
   echo "       pressure levels ( see item 12 in eta_run.csh file )"
   echo " "
   exit 1
endif
