...
C   99-06-10  PYLE	  MADE LINUX VERSION LIKE Y2K VERSION (ADDED 203)
C
C
...
C
     ...
     &    IGDS(3).EQ.203) THEN
        ...
        ELSE IF (IGDS(3).EQ.201.OR.IGDS(3).EQ.202
     + 	.OR.IGDS(3).EQ.203) THEN
...
C$$     PROCESS POLAR STEREOGRAPHIC GRID TYPES
      ELSE IF (IGDS(3) .EQ. 5) THEN
        ...
        GDS(32) = CHAR(0)
      ENDIF
C      PRINT 101,(ichar(GDS(IG)),IG=1,32)
