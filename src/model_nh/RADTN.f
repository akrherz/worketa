...
C     *         the model-predicted clouds are linked into the models *
...
Cmp
	IF (I.eq.16.and.J.eq.11.and.MYPE.eq.4)then
C	if (SHORT) write(6,633) MYPE,L,TENDS(I,LL)
C	if (LONG) write(6,634) MYPE,L,TENDL(I,LL)
	ENDIF
  633 format('MYPE,L,TENDS: ',I2,1x,I3,1x,e12.5)
  634 format('MYPE,L,TENDL: ',I2,1x,I3,1x,e12.5)
Cmp
