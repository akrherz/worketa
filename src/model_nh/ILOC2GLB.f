...
C------------------------------------------------------------
      ...
      INCLUDE "mpif.h"
C------------------------------------------------------------
      INTEGER ARRL(IDIM1:IDIM2,JDIM1:JDIM2),ARRG(IM,JM)
      INTEGER ARRX(IDIM1:IDIM2,JDIM1:JDIM2)
C------------------------------------------------------------
...
C
      IF(MYPE.NE.0)THEN
        CALL MPI_SEND(ARRL,NUMVAL,MPI_INTEGER,0,MYPE
...
C
        DO IPE=1,NPES-1
          CALL MPI_RECV(ARRX,NUMVAL,MPI_INTEGER,IPE,IPE
