...
C
      CALL MPI_BCAST(NO_REDUCE,1,MPI_LOGICAL,0,mpi_comm_comp,IERR)
      CALL MPI_BCAST(STDRD,1,MPI_LOGICAL,0,mpi_comm_comp,IERR)
      CALL MPI_BCAST(LHMNT,1,MPI_INTEGER,0,mpi_comm_comp,IERR)
C
C     COLLECT T AND Q
C
