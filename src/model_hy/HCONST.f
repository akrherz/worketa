...
Cmp       C) THERE WILL BE NO EMBEDDED 0(ZERO); ALL 0S WILL
...
C        ARRANGED IN DECREASING ORDER
      ...
      ZERO=0.
C
Cmp******FOLLOWING ARE POSITIVE FLOATING POINT CONSTANTS(HS)
C       ARRANGED IN DECREASING ORDER
      H83E26=8.3E26
      H71E26=7.1E26
      H1E15=1.E15
...
Cmp      H1M60=1.0E-60
Cmp
Cmp	changed to avoid going out of 32 bit range
Cmp
      H1M60=1.0E-35
C
Cmp******FOLLOWING ARE NEGATIVE FLOATING POINT CONSTANTS (HMS)
