...
C
     ...
     2 DSRCE(28,NBLY)
C
      DIMENSION TEMP(IDIM1:IDIM2,LP1),T(IDIM1:IDIM2,LP1)
      DIMENSION AVEPHI(IDIM1:IDIM2,LP1),EMISS(IDIM1:IDIM2,LP1)
C
      DIMENSION IT1(IDIM1:IDIM2,LL3P),IVAL(IDIM1:IDIM2,LP1),
     5  FYO(IDIM1:IDIM2,LP1),DU(IDIM1:IDIM2,LP1),
     6  WW1(IDIM1:IDIM2,LP1),WW2(IDIM1:IDIM2,LP1),
     7  TMP3(IDIM1:IDIM2,LP1),TMP5(IDIM1:IDIM2),TMP9(IDIM1:IDIM2)
...
C---VARIABLES IN THE ARGUMENT LIST
      DIMENSION FXOE1(IDIM1:IDIM2,LP1),DTE1(IDIM1:IDIM2,LP1),
     1          FXOE2(IDIM1:IDIM2,LP1),DTE2(IDIM1:IDIM2,LP1),
     2    G1(IDIM1:IDIM2,LP1),G2(IDIM1:IDIM2,L),G3(IDIM1:IDIM2,LP1),
     &    G4(IDIM1:IDIM2,LP1),G5(IDIM1:IDIM2,L)
C
...
230   CONTINUE
     ...
     1        WW2(I,K+1)*DTE1(I,K+1)*EM1V(IT1(I,K+1)+1)+
     2        WW1(I,K+1)*DU(I,K)*EM1V(IT1(I,K+1)+28)+
     3        DTE1(I,K+1)*DU(I,K)*EM1V(IT1(I,K+1)+29)
      G2(I,K)=WW1(I,K)*WW2(I,K+1)*EM1V(IT1(I,K+LP2-1))+
     1        WW2(I,K+1)*DTE1(I,K)*EM1V(IT1(I,K+LP2-1)+1)+
     1        WW1(I,K)*DU(I,K)*EM1V(IT1(I,K+LP2-1)+28)+
     2        DTE1(I,K)*DU(I,K)*EM1V(IT1(I,K+LP2-1)+29)
240   CONTINUE
      DO 241 KP=2,LP1
      DO 241 I=MYIS,MYIE
...
244   CONTINUE
     ...
     1        WW2(I,K+1)*DTE1(I,K+1)*EM1VW(IT1(I,K+1)+1)+
     2        WW1(I,K+1)*DU(I,K)*EM1VW(IT1(I,K+1)+28)+
     3        DTE1(I,K+1)*DU(I,K)*EM1VW(IT1(I,K+1)+29)
      G5(I,K)=WW1(I,K)*WW2(I,K+1)*EM1VW(IT1(I,K+LP2-1))+
     1        WW2(I,K+1)*DTE1(I,K)*EM1VW(IT1(I,K+LP2-1)+1)+
     1        WW1(I,K)*DU(I,K)*EM1VW(IT1(I,K+LP2-1)+28)+
     2        DTE1(I,K)*DU(I,K)*EM1VW(IT1(I,K+LP2-1)+29)
242   CONTINUE
C
      RETURN
      END
